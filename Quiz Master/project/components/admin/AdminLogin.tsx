          ...
          <div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl focus:ring-2 focus:ring-red-400 focus:border-red-400 transition-all duration-200 text-white placeholder-white/50 backdrop-blur-sm"
          ...
          <div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-3 bg-white/10 border border-white/20 rounded-xl focus:ring-2 focus:ring-red-400 focus:border-red-400 transition-all duration-200 text-white placeholder-white/50 backdrop-blur-sm"
