...
export default function AdminDashboard({ onLogout }: AdminDashboardProps) {
  ...
  const exportData = () => {
    ...
    link.href = url;
    link.download = `quiz-admin-data-${new Date().toISOString().split('T')[0]}.json`;
    link.click();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-96 h-96 bg-red-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="relative">
                <div className="w-12 h-12 bg-red-500/20 backdrop-blur-sm rounded-2xl flex items-center justify-center border border-red-400/30">
              ...
              <div>
                ...
                <p className="text-white/70">Welcome back, {adminUsername}</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
                ...
                <div className="bg-white/10 rounded-xl p-6 border border-white/20">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-white">Logged in as: {adminUsername}</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Shield className="w-5 h-5 text-blue-400" />
                      <span className="text-white/70">Admin privileges active</span>
                    </div>
                    <button 
                      onClick={onLogout}
                      className="w-full px-4 py-2 bg-red-500/20 text-red-300 rounded-lg hover:bg-red-500/30 transition-all border border-red-400/30 flex items-center justify-center space-x-2"
                    >
                      <LogOut className="w-4 h-4" />
                ...
                <div className="bg-white/10 rounded-xl p-6 border border-white/20">
                  ...
                  <div className="space-y-4">
                    <div className="text-sm text-white/70">
                      ...
                      <p>• Failed login attempts: 3 max</p>
                      <p>• Account lockout: 5 minutes</p>
